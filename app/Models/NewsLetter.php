...
class NewsLetter extends Model
{
    ...
    static function getTableData()
    {
        ...
        return array(
            ...
            'back_route' => route('news_letters.index'),
            'index_route' => route('news_letters.index'),
            'create_route' => route('news_letters.create'),
            'columns' => [
                '#',
                __('translation.Email'),
                __('translation.Action'),
            ],
            'ajax_url' => route('news_letters.get-ajax-data'),
            'buttons' => $buttons,
            'js_columns' => [
