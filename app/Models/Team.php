...
class Team extends Model
{
    ...
    static function getTableData()
    {
        ...
        return array(
            ...
            'is_add' => auth()->user()->can('settings.team.add') ? true : false,
            'is_modal' => true,
            'is_modal_large' => false,
            'is_back_button' => false,
            'view_deleted_btn' => auth()->user()->can('settings.team.restore') ? false : false,
            'back_route' => route('settings.teams.index'),
            'index_route' => route('settings.teams.index'),
            'create_route' => route('settings.teams.create'),
            'columns' => [
                '#',
                __('translation.Name'),
            ...
            'ajax_url' => route('settings.teams.get-ajax-data'),
            'buttons' => $buttons,
            'js_columns' => [
