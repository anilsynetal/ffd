            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    if (auth()->user()->can('settings.contacts.edit')) {
                        $btn .= '<a href="javascript:void(0);" data-url="' . route('settings.contacts.edit', $row->id) . '" class="btn btn-outline-warning btn-sm loadRecordModal" title="' . __('translation.Edit') . '"> <i class="fas fa-pencil-alt"></i></a>&nbsp;';
                    }
                ...
                ->rawColumns(['DT_RowIndex', 'created_at', 'created_by', 'status', 'action', 'image', 'map'])
                ->make(true);
        }
    }
}
