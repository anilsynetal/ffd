      ...
      <div class="container">
          ...
          <div class="case-slider slick-initialized slick-slider aos-init aos-animate" data-aos="fade-up">
              <div class="slick-list draggable">
                  <div class="slick-track" style="opacity: 1; width: 1935px; transform: translate3d(0px, 0px, 0px);">
                      @foreach ($case_studies as $key => $case_study)
                          <div class="sasly-project-item style-one slick-slide slick-current slick-active"
                              data-slick-index="{{ $key }}" aria-hidden="false" tabindex="{{ $key }}"
                              style="width: 615px;">
                              <div class="thumbnail">
                                  <img src="{{ asset($case_study->image) }}" alt="{{ $case_study->title }}">
                                  <div class="hover-overlay"></div>
                              </div>
                              <div class="content">
                                  <h4 class="title"><a href="javscript:void(0)"
                                          tabindex="{{ $key }}">{{ $case_study->title }}</a></h4>
