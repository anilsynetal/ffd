 <section class="what-we-sb" id="services-section">
     <div class="wrapper primary-bg pt-30 pb-20">
         <div class="container">
             <div class="row">
                 <div class="col-lg-12">
                     <!--=== Section Title  ===-->
             ...
             <div class="row justify-content-center">
                 @foreach ($services as $k => $service)
                     <div class="col-xl-4 col-md-6 col-sm-12">
                         <div class="sasly-info-box style-one mb-30 services-content" data-aos="fade-up">
                             <div class="content">
                                 {{-- <div class="number">{{ ++$k }}</div> --}}
                                 <h4 class="title text-center">{{ $service->title }}</h4>
